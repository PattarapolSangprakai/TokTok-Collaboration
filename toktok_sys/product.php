...
<body>
    ...
    <div class="pop-links" id="pop-links">
        <ul>
          ...
          <li><a href="#">Style</a></li>
            <li ><a class="sub-product" href="product.php?bid=1">Dive</a></li>
            <li><a class="sub-product" href="product.php?bid=2">Dress</a></li>
            <li><a class="sub-product" href="product.php?bid=3">GMT</a></li>
          <li><a href="#">BLOG</a></li>
          <li><a href="#">CONTACT</a></li>
        </ul>
      </div>
    ...
    <section class="content" >
        <?php 
            ...
            if(isset($_GET['bid'])){
                $bid = $_GET['bid'];
                $result =  mysqli_query($conn, "SELECT b.Brand, Name, Price, Product_img, Product_ID  FROM product p join product_brand b where p.Brand = b.Brand_ID and b.brand_ID = $bid;"); 
                $q = mysqli_fetch_assoc(mysqli_query($conn, "SELECT Brand from product_brand where Brand_ID = $bid"));
            }
            
        
            else{
                $result = mysqli_query($conn, "SELECT b.Brand, Name, Price, Product_img, Product_ID  FROM product p join product_brand b where p.Brand = b.Brand_ID;  "); 
            }
           
            
        ?>
        <div style="height: 40px; text-align: center;"><h1 style="font-weight: 400; font-size: 30px;"><?php if(isset($_GET['bid'])){echo $q['Brand'];} else{echo 'ALL Watches';}?></h1></div>
        <div id="product-con">
        ...
        <?php
                    ...
                    <a href="product_page.php?id=<?= $row['Product_ID'] ?>">
                        <div class="product-div">
                            ...
                            <p class="product-brand"><?=$row['Brand']?></p>
                            
                            <center><img src="<?php echo $row['Product_img'];?>" alt=""></center>
                            <center><p class="product-name"><?=$row['Name']?></p> </center>
                            <center><p class="product-name">Price: <?=$row['Price']?></p> </center>
