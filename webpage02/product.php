           ...
           <div class="container" style="width: 700px;"> 
                ...
                <?php 
                    ...
                    if(mysqli_num_rows($result) > 0){
                        ...
                        {
                    ?>
                    <div class="col-md-6" style="padding: 20px; border: top 50px;">
                        <form method = "post" action="product.php?action=add&id=<?php echo $row["Product_ID"];?>">
                            ...
                            <h4 class="text-muted"><?php echo $row["Color"]; ?></h4>
                            ...
                            <input type="submit" name="add_to_cart" style="margin-top:5px; align:center;" class="btn btn-success" value="Add to Cart" />  
                            </div>
                        </form>       
                    <?php         
