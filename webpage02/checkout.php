<?php 
  ...
  if(isset($_POST['checkout'])){
    ...
    if(!empty($_SESSION["shopping_cart"]))
    {
        ...
        $order = "INSERT INTO `shop_order` VALUES('','$uid','$yourdate','1','1','1','$total','2','$token')";
...
<div class="row">
  ...
  <?php
      ...
      if(!empty($_SESSION["shopping_cart"])){
        ...
        {
  ?>
          <p><?php echo $values["item_name"];?></a> <span class="price"><?php echo $values["item_price"];?>฿</span></p><br>
  ...
  ?>
      ...
      <button type="submit" name="checkout">Log in</button>
    </div>
  </div>
  </form>
</div>
